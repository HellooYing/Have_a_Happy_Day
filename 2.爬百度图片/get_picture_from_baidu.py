...
if __name__ == '__main__':
    ...
    # crawler.start('轿车', 10, 2)  # 抓取关键词为 “轿车”，总数为 1 页（即总共 1*60=60 张），开始页码为 2
    crawler.start('轿车', 30, 1)  # 抓取关键词为 “轿车”，总数为 10 页（即总共 10*60=600 张），起始抓取的页码为 1
    # crawler.start('轿车', 5)  # 抓取关键词为 “轿车”，总数为 5 页（即总共 5*60=300 张）
